...
@section('entete')
            ...
            <div class="content">
                ...
                <!-- BEGIN: Wizard Layout -->
                <form action="{{route('Postaddcoach')}}" method="POST" enctype="multipart/form-data" >
                @csrf
                    ...
                    <div class="px-5 sm:px-20 mt-10 pt-10 border-t border-gray-200">
                        ...
                        <div class="grid grid-cols-12 gap-4 row-gap-5 mt-5">
                            ...
                            <div class="intro-y col-span-12 sm:col-span-6">
                                ...
                                <input name="titre" type="text" class="input w-full border flex-1" placeholder="Ex: Coach principal Féminin">
                            </div>
                            <div class="intro-y col-span-12 sm:col-span-6">
