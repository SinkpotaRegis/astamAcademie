...
@section('entete')
            ...
            <div class="content">
                ...
                <!-- BEGIN: Wizard Layout -->
                <form action="{{route('Postinfosstage')}}" method="POST" enctype="multipart/form-data" >
                @csrf
                <div class="intro-y box py-10 sm:py-20 mt-5">
                    <div class="px-5 mt-10">
                        <div class="font-medium text-center text-lg">STAGE DES PRODIGUES DE AS-TAM ACADEMY </div>
                    </div>
